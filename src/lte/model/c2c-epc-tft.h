 ...
 * 
 */
class C2cEpcTft : public SimpleRefCount<EpcTft>
{
...
public:
  ...
  struct PacketFilter
  {
    ...
    c2cAddress remoteAddress;     /**< IPv4 address of the remote host  */
    Ipv4Mask remoteMask; /**< IPv4 address mask of the remote host */
    c2cAddress localAddress;      /**< IPv4 address of the UE */
  ...
  uint8_t Add (PacketFilter f);
    ...
    bool Matches (Direction direction,
		  c2cAddress remoteAddress, 
		  c2cAddress localAddress, 
		  uint16_t remotePort,
		  uint16_t localPort,
...
std::ostream& operator<< (std::ostream& os, C2cEpcTft::Direction& d);
