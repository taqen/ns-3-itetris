 ...
 */
class C2cEpcTftClassifier : public SimpleRefCount<EpcTftClassifier>
{
public:
   ...
   * 
   */
  void Add (Ptr<C2cEpcTft> tft, uint32_t id);
   ...
   */
  uint32_t Classify (Ptr<Packet> p, C2cEpcTft::Direction direction);
  
protected:
  
  std::map <uint32_t, Ptr<C2cEpcTft> > m_tftMap;
