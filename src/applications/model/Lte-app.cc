...
//#include "ns3/lte-basestation-manager.h"
//#include "ns3/lte-userequipment-manager.h"
...
//#include "ns3/lte-tags.h"
#include "Lte-app.h"
//#include "ns3/lte-manager.h"
...
LteApp::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::LteApp")
    ...
    .AddAttribute ("PortIP", "The port of the ip messages",     // modified by SV
    		   UintegerValue (0),
    		   MakeUintegerAccessor (&LteApp::m_portIP),     // modified by SV
    ...
    .AddAttribute ("ApplicationType", " Determines the Transmission Mode used to transmit Data (AM,MULTICAST,BROADCAST,etc) ",     // modified by SV
    		   ...
    		   MakeStringAccessor (&LteApp::m_applicationType),     // modified by SV
    		   MakeStringChecker())   
